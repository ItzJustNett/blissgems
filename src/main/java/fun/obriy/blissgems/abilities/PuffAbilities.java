...
public class PuffAbilities {
    ...
    public void dash(Player player) {
        ...
        player.sendMessage(this.plugin.getConfigManager().getFormattedMessage("ability-activated", "ability", "Dash"));
    }
    ...
    public void breezyBash(Player player) {
        ...
        this.plugin.getAbilityManager().useAbility(player, abilityKey);
        player.sendMessage(this.plugin.getConfigManager().getFormattedMessage("ability-activated", "ability", "Breezy Bash"));
    }
}
